            ...
            .then(adminData => {
                ...
                const row = `
                    <tr>
                        ...
                        <td>
                            <input type="button" value="同意" onclick="approveApply(${conscription.conscriptionId})">
                            <input type="button" value="拒绝" onclick="refuseApply(${conscription.conscriptionId})">
                        </td>
                    </tr>
                `;
...
function refuseApply(conscriptionId){
    ...
    fetch(`http://localhost:8088/conscription/${conscriptionId}`)
        .then(response => response.json())
        .then(conscriptionData => {
            const updatedData = {
                ...
                state: "N",
                conscriptionTime: conscriptionData.data.conscriptionTime,
